      ...
      <div v-if="showModal" class="fixed inset-0 flex items-center justify-center z-10">
        ...
        <div :class="[
          ...
          <div v-if="currentProject.youtube_url" 
               class="w-full p-4 md:p-8 md:h-1/3 overflow-y-auto scrollbar-thin">
          ...
          <template v-else>
            <!-- Images Section -->
            <div class="w-full h-7/12 md:h-full md:w-2/3 overflow-y-scroll scrollbar-none">
            ...
            <!-- Description Section -->
            <div class="w-full h-5/12 md:h-full md:w-1/3 relative overflow-auto scrollbar-thin">
